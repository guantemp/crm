 ...
 */
public class CategoryEntry1 extends Entry1 {
    private Category category;
    private static final String PREFIX = "category_";

    public CategoryEntry1(Category category, Ratio ratio) {
    ...
    public String toString() {
        return new StringJoiner(", ", CategoryEntry1.class.getSimpleName() + "[", "]")
