...
public final class Operator {
    ...
    public Operator(String identity, String name) {
        setIdemtity(identity);
        setName(name);
    }

    private void setIdemtity(String identity) {
    ...
    private void setName(String name) {
        ...
        if (name.isEmpty())
            throw new IllegalArgumentException("name must initial.");
        this.name = name;
    }
}
